...
//       <img src={college.image} alt={college.name} className="w-full h-64 object-cover rounded mb-4" />
//       <p className="text-lg mb-4">{college.description}</p>
//       <p className="mb-2">Reference Code: <strong>{college.referenceCode}</strong></p>
//       <a
//         href={college.link}
//         target="_blank"
      ...
      <div className="p-6 my-10 max-w-7xl mx-auto">
        <div className="flex gap-10 mb-6 bg-gradient-to-b from-white to-white dark:bg-gradient-to-b dark:from-[#ffffff0d] border-t dark:border-[#ffffff14] dark:to-[#ffffff04] shadow-[0_0_10px_6px_rgba(142,142,142,0.05)] dark:shadow-none p-5 px-7 rounded-sm">
          ...
          <div className="flex-1">
            <h1 className="text-2xl font-bold text-transparent bg-clip-text bg-[linear-gradient(90deg,#A07DF1,#F69DBA)] mb-2">{college.name}</h1>
            ...
            <div className="flex gap-8">
              ...
              <Button asChild className="text-transparent bg-clip-text bg-[linear-gradient(90deg,#A07DF1,#F69DBA)] hover:brightness-75 shadow-none">
        ...
        <Tabs defaultValue="info" className="w-full">
          <TabsList className="bg-gradient-to-b from-white to-white dark:bg-gradient-to-b dark:from-[#ffffff0d] border-t dark:border-[#ffffff14] dark:to-[#ffffff04] shadow-[0_0_10px_6px_rgba(142,142,142,0.05)] dark:shadow-none rounded-sm  h-auto p-0 px-2 w-full justify-start gap-2">
            {[
              "info", "courses & Fees", "gallery", "hostel", "admission",
              "faqs", "scholarship", "announcement", "faculty",
              "reviews", "qna"
            ].map((tab) => (
              <TabsTrigger
                key={tab}
          ...
          <TabsContent value="info" className="mt-6 bg-gradient-to-b from-white to-white dark:bg-gradient-to-b dark:from-[#ffffff0d] border-t dark:border-[#ffffff14] dark:to-[#ffffff04] shadow-[0_0_10px_6px_rgba(142,142,142,0.05)] dark:shadow-none rounded-sm px-4 py-5 space-y-6 ">
            <Collapsible>
              ...
              <CollapsibleContent className="p-4">
                <p className="dark:text-white text-black">{college.description}</p>
              </CollapsibleContent>
            </Collapsible>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {campusHighlights.map((highlight, index) => (
                  <Card key={index} className=" bg-gradient-to-b from-white to-white dark:bg-gradient-to-b dark:from-[#ffffff0d] border-t dark:border-[#ffffff14] dark:to-[#ffffff04] shadow-[0_0_10px_6px_rgba(142,142,142,0.10)] dark:shadow-none rounded-sm">
                    <CardHeader className="pb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 flex items-center justify-center">
                          <Building2 className="w-5 h-5" />
                        </div>
                        <CardTitle className="text-black dark:text-white text-sm">{highlight.title}</CardTitle>
                      </div>
                    </CardHeader>
          ...
          {[
            "courses & Fees", "gallery", "hostel", "admission",
            "faqs", "scholarship", "announcement", "faculty",
            "reviews", "qna"
          ].map((tab) => (
            <TabsContent key={tab} value={tab} className="mt-6">
              <div className="p-6 bg-gradient-to-b from-white to-white dark:bg-gradient-to-b dark:from-[#ffffff0d] border-t dark:border-[#ffffff14] dark:to-[#ffffff04] shadow-[0_0_10px_6px_rgba(142,142,142,0.05)] dark:shadow-none rounded-lg">
                <p className="text-black dark:text-white capitalize">{tab} information will be displayed here.</p>
              </div>
            </TabsContent>
          ))}
        </Tabs>
