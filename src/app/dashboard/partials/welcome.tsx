...
export default function Welcome() {
  ...
  return (
    <div className="text-center flex flex-col gap-4  mx-auto lg:mb-10 lg:mt-5">
      <h1 className="lg:text-[32px] text-[24px] text-black dark:text-white font-bold font-poppins lg:mb-5">
        Hey there{" "}
      ...
      <span className="text-center dark:text-[#ffffff70] text-black lg:text-[20px] text-sm ">
