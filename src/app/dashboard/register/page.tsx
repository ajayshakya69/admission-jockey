...
<div className='flex gap-[32px] flex-col'>
        <div className="space-y-[3px]">
          <Label className='text-[16px]' htmlFor="name">Hey there! What’s your name?</Label>
          <Input
            id="name"
            name="name"
            value={formData.name}
        ...
        <div className="flex justify-center gap-4 pt-4">
          ...
          <Button type="submit" className="bg-[linear-gradient(90deg,#A07DF1,#F69DBA)] w-[141px] h-[44px] text-white">
            Register
          </Button>
        </div>
      </form>
