        ...
        <div className="lg:min-h-screen" >
            <div className="grid lg:grid-cols-2 grid-rows-2 justify-between items-center lg:gap-15 gap-10 lg:h-110 lg:px-20 p-5">
                <div className=" flex flex-col  gap-5 ">
                    <h1 className="lg:text-[40px] text-[24px] font-semibold ">Lost in Choices? Let AI Be <br className='lg:block hidden' /> Your Guide</h1>
                    <span className='lg:text-base text-sm'>Explore the smartest way to plan your education and <br className="lg:block hidden" /> career — all in one place.</span>
            ...
            <div className="lg:block relative hidden place-items-center scroll-none overflow-y-clip w-full">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1514 400" fill="none"   preserveAspectRatio="none" className="w-full h-auto">
